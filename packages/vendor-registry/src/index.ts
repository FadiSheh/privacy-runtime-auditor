...
const registry: VendorRegistryEntry[] = [
  ...
  {
    id: 'vendor_mouseflow',
    canonicalName: 'Mouseflow',
    aliases: ['Mouseflow'],
    domains: ['mouseflow.com', 'cdn.mouseflow.com', 'o2.mouseflow.com'],
    defaultCategory: 'analytics',
    notes: 'Session replay and heatmap tooling.',
    confidenceRules: ['domain-match'],
  },
  {
    id: 'vendor_contentsquare',
    canonicalName: 'Contentsquare',
    aliases: ['Contentsquare', 'ContentSquare'],
    domains: ['contentsquare.net', 'contentsquare.com', 't.contentsquare.net'],
    defaultCategory: 'analytics',
    notes: 'Digital experience analytics and session replay tooling.',
    confidenceRules: ['domain-match'],
  },
  {
    id: 'vendor_fingerprintjs',
    canonicalName: 'FingerprintJS',
    aliases: ['FingerprintJS', 'Fingerprint'],
    domains: ['fingerprint.com', 'fpjscdn.net', 'metrics.fingerprint.com'],
    defaultCategory: 'analytics',
    notes: 'Browser fingerprinting and device intelligence scripts.',
    confidenceRules: ['domain-match'],
  },
  {
    id: 'vendor_databox',
